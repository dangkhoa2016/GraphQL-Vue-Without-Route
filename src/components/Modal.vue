...
<script>
  ...
  const validateColor = (color) => {
    return ['', 'danger', 'success', 'primary', 'warning', 'info', 'light', 'dark'].includes(color);
  };
  ...
  export default {
    props: {
      ...
      modalDialogSize: {
        type: String,
        default: 'md',
        validator: (prop) => ['', 'sm', 'md', 'lg', 'xl', 'fullscreen'].includes(prop),
      },
      bodyBgVariant: {
        type: String,
        default: '',
      ...
      modalDialogClasses() {
        return [
          this.dialogClass,
          {
            ...
            [`modal-fullscreen-${this.modalDialogSize}-down`]: this.modalDialogFullscreen && this.modalDialogSize !== undefined,
            [`modal-${this.modalDialogSize}`]: this.modalDialogSize !== undefined,
      ...
      bodyClasses() {
        return [
          this.bodyClass,
          {
            ...
            [`border-${this.bodyBorderVariant}`]: this.bodyBorderVariant !== undefined,
            [`text-${this.bodyTextVariant}`]: this.bodyTextVariant !== undefined,
          },
        ];
      },
      headerClasses() {
        return [
          this.headerClass,
          {
            ...
            [`border-${this.headerBorderVariant}`]: this.headerBorderVariant !== undefined,
            [`text-${this.headerTextVariant}`]: this.headerTextVariant !== undefined,
          },
        ];
      },
      footerClasses() {
        return [
          this.footerClass,
          {
            ...
            [`border-${this.footerBorderVariant}`]: this.footerBorderVariant !== undefined,
            [`text-${this.footerTextVariant}`]: this.footerTextVariant !== undefined,
          },
        ];
      },
      titleClasses() {
