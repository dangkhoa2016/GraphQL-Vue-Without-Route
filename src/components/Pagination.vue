		...
		<ul class="pagination justify-content-center">
			...
			<li v-if="displayedPages[0] > 2" class="page-item">
				<a
					href="#"
					class="page-link"
					@click.prevent="changePage(displayedPages[0] - 1)"
				>
					...
				</a>
			</li>
			...
			>
				<a href="#" class="page-link" @click.prevent="changePage(pageNumber)">
					{{ pageNumber }}
				</a>
			</li>
			...
			>
				<a
					...
					class="page-link"
					@click.prevent="
						changePage(displayedPages[displayedPages.length - 1] + 1)
					"
				>
					...
				</a>
			...
			<li
				...
				class="page-item"
			>
				<a href="#" class="page-link" @click.prevent="changePage(totalPages)">
					{{ totalPages }}
				</a>
			</li>
